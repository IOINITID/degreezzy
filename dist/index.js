 ...
 */
var getDirectionByDegrees = function (degrees) {
    var direction;
    switch (true) {
 ...
 */
var getDegreesByDirection = function (direction, rounding) {
    var degrees;
    switch (true) {
        case direction === "NNE":
            degrees = 22.5;
 ...
 */
var getGramsFromKilograms = function (kilograms) {
    var GRAMS_IN_KILOGRAM = 1000;
 ...
 */
var getKilogramsFromGrams = function (grams) {
    var GRAMS_IN_KILOGRAM = 1000;
 ...
 * @return {Number} Degrees value.
 */
var getDegreesFromRadians = function (radians) {
